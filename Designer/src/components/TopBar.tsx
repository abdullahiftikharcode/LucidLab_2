        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <button 
              ...
              className={`flex items-center justify-center rounded-lg size-10 transition-colors relative ${showNotifications ? 'bg-primary/10 text-primary' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'}`}
            >
                    ...
                    {loadingNotifications ? (
                      ...
                      notifications.map(n => (
                        <Link 
                          ...
                          className={`block px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors border-b border-slate-50 dark:border-slate-800 last:border-0 ${!n.isRead ? 'bg-primary/[0.03] dark:bg-primary/[0.05]' : ''}`}
                        >
                          ...
                          <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-1 font-medium">{formatRelativeTime(n.createdAt)}</p>
                        </Link>
                      ))
                    )}
                  </div>
